...
namespace ClassLibrary1
{
   ...
   InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class DsRect
		...
		/// VB.Net doesn't support implicit cast. <see cref="DsRect.ToRectangle"/> for similar functionality.
		/// <code>
		...
		/// VB.Net doesn't support implicit cast. <see cref="DsRect.FromRectangle"/> for similar functionality.
		/// <code>
